...
namespace Nuke.Common.Tools.Source.Tooling
{
    ...
    public class VTF : Tools, IDownloadable
    {
        ...
        /// </summary>
        public bool? NoReflectivity { get; set; }
        ...
        /// </summary>
        public bool? NWrap { get; set; }

        /// <summary>
        /// Normal map scale to use
        /// </summary>
        public float? NScale { get; set; }

        /// <summary>
        /// Normal map alpha result to set
        /// </summary>
        public NormalAlpha? NAlpha { get; set; }

        /// <summary>
        /// Normal map height calculation to use
        /// </summary>
        public NormalHeight? NHeight { get; set; }

        /// <summary>
        /// Normal map generation kernel to use
        /// </summary>
        public NormalKernel? NKernel { get; set; }
        ...
        /// </summary>
        public string MSharpen { get; set; }
        ...
        /// </summary>
        public float? GCorrection { get; set; }
        ...
        /// </summary>
        public int? RClampHeight { get; set; }

        /// <summary>
        /// Maximum width to resize to
        /// </summary>
        public int? RClampWidth { get; set; }
        ...
        /// </summary>
        public SharpenFilter? RSharpen { get; set; }

        /// <summary>
        /// Resize filter to use
        /// </summary>
        public ResizeFilter? RFilter { get; set; }

        /// <summary>
        /// Resize method to use
        /// </summary>
        public ResizeMethod? RMethod { get; set; }
        ...
        /// </summary>
        public string AlphaFormat { get; set; }
    ...
    public static partial class VTFExtensions
    {
        ...
        /// <returns></returns>
        [Pure]
        public static T SetOutput<T>(this T toolSettings, string output) where T : VTF
        {
        ...
        /// <returns></returns>
        [Pure]
        public static T ResetOutput<T>(this T toolSettings) where T : VTF
        {
            toolSettings = toolSettings.NewInstance();
