...
namespace Nuke.Source.Tooling
{
	...
	[Serializable]
	public class BSPZIP : Abstractions.Tooling
	{

		public BSPZIP() : base("bspzip.exe")
		{
	...
	public static partial class Extensions
	{
		...
		/// <returns></returns>
		[Pure]
		public static T SetFileList<T>(this T toolSettings, string fileList) where T : BSPZIP
		{
		...
		/// <returns></returns>
		[Pure]
		public static T ResetFileList<T>(this T toolSettings) where T : BSPZIP
		{
			toolSettings = toolSettings.NewInstance();
